...
public class Principal {
    ...
    public static booolean nombJugador(){
        int pt=0;
        Scanner teclado = new Scanner(System.in);
        boolean bandera= false;
        System.out.println("Ingrese el nombre del jugador a buscar");
        String nombJugador = new 
        String nombreJugador = "data/jugadores.dat";
        LecturaSecuencialJugador lectura 
                =LecturaSecuencialJugador(nombreArchivoClub);
        lectura.establecerRegistroBuscado(nomJugador);
